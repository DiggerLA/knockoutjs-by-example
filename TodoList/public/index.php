    ...
    <div class="columns is-centered">      
      <div class="column is-6-tablet is-6-desktop is-half-widescreen is-one-quarter-fullhd">  
          ...
          <div class="field mr-1">
            ...
            <div class="control has-icons-left">
              <input class="input is-primary" type="text" id="taskName" placeholder="Enter task name"
                data-bind="value: TodoList.task.name">
          ...
          <div class="field mr-1">
            ...
            <div class="control has-icons-left">
              <input class="input is-primary" type="text" id="decription" placeholder="Enter description"
                data-bind="value: TodoList.task.description">
              <span class="icon is-small is-left">              
        ...
        <!-- <div class="field is-grouped"> -->
          <div class="field is-grouped mr-2">
            ...
            <div class="control has-icons-left">
              <div class="select">
                <select id="priority"
                  data-bind="value: TodoList.task.priority">
          ...
          <div class="field">
            <div class="control">
              <button class="button is-primary is-fullwidth" 
                data-bind="click: TodoList.addTask">
                Add
              </button>
            </div>
          </div>  
        ...
        <div class="field is-grouped">          
          ...
          <div class="control">
            <button class="button" data-bind="click:TodoList.sortByPriority">priority</button>
          </div>
          <div class="control">
            <button class="button" data-bind="click:TodoList.sortByName">name</button>
          </div>
        </div>
        ...
        <table class="table is-striped is-hoverable is-fullwidth">
          ...
          <tbody data-bind="foreach:TodoList.tasks">
            <tr data-bind="css:{ 'has-background-success-light': status() == 'complete'}">
              ...
              <td>
                <button class="button is-success is-small is-rounded mb-1"
                  data-bind="click: TodoList.completeTask, 
        ...
        <div>
          <span class="field is-grouped" data-bind="visible: TodoList.tasks().length > 0">
            <label class="label mr-2">Total: <span data-bind="text: TodoList.tasks().length"></span></label>
            <label class="label">Completed: <span data-bind="text: TodoList.numOfCompletedTasks()"></span></label>
          </span>
          <span data-bind="visible: TodoList.tasks().length == 0">
